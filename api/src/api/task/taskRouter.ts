...
taskRouter.patch('/:id', validateRequest(UpdateTaskSchema), taskController.updateTask);
...
taskRouter.delete('/:id', validateRequest(DeleteTaskSchema), taskController.deleteTask);
